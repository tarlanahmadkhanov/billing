...
public class CheckLimitResult {
    ...
    public CheckLimitResult(boolean isTransactionAccepted) {
        this.isTransactionAccepted = isTransactionAccepted;
    }

    public CheckLimitResult(boolean isTransactionAccepted, String accountCurrency, BigDecimal rateEUR, BigDecimal rateUSD, List<String> availableCurrencies, BigDecimal maxAvailableAmountAZN, BigDecimal maxAvailableAmountUSD, BigDecimal maxAvailableAmountEUR) {
        this.isTransactionAccepted = isTransactionAccepted;
